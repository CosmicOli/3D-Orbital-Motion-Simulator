...
{
    internal partial class ExportBodysEphemerisForm : Form
    {
        ...
        public ExportBodysEphemerisForm(MainForm mainForm)
        {
            InitializeComponent();
        ...
        private void pickBodyInputTextBox_KeyPress(object sender, KeyPressEventArgs e)
        {
        ...
        private void exportBodysEphemerisButton_Click(object sender, EventArgs e)
        {
            if (mainForm.tree.IsEnabled() == true)
            {
                mainForm.tree.ExportBodysEphemeris(pickBodyInputTextBox.Text.ToLower());
            }
            else
            {
